    ...
    public partial class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        public virtual async Task<TopMenuModel> PrepareTopMenuModelAsync()
        {
            ...
            var model = new TopMenuModel
            {
                ...
                // QUIMS EDIT //
                //IsAuthenticated = _customerService.IsRegisteredAsync(customer),
                //ShoppingCartEnabled = _permissionService.AuthorizeAsync(StandardPermissionProvider.EnableShoppingCart),
                // QUIMS EDIT // 
