    ...
    public class WidgetsInternetInformationStatsController : BasePluginController
    {
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var model = new ConfigurationModel
            {
                ...
                ShowProductImagesOnShoppingCart = internetInformationStatsSettings.ShowProductImagesOnShoppingCart,
            ...
            if (storeScope > 0)
            {
                ...
                model.ShowProductImagesOnShoppingCart_OverrideForStore = await _settingService.SettingExistsAsync(internetInformationStatsSettings, x => x.ShowProductImagesOnShoppingCart, storeScope);
        ...
        public async Task<IActionResult> Configure(ConfigurationModel model)
        {
            ...
            internetInformationStatsSettings.ShowProductImagesOnShoppingCart = model.ShowProductImagesOnShoppingCart;
            ...
            await _settingService.SaveSettingOverridablePerStoreAsync(internetInformationStatsSettings, x => x.ShowProductImagesOnShoppingCart, model.ShowProductImagesOnShoppingCart_OverrideForStore, storeScope, false);
